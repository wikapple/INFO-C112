...
public class TableOne {
    ...
    //The Constructor
    TableOne(int diveNumberInput){
        diveNumber = diveNumberInput;
    ...
    public char getPressureGroup(){
        int depthEstimate = getDepthEstimate();
        ...
        int timeRoundedUp = timeRounder(timeEstimate);
    ...
    private int getDepthEstimate(){
        Scanner in = new Scanner(System.in);
        int depthEstimate = 0;
        boolean depthEstimateLoop = true;
        while (depthEstimateLoop){
            System.out.println("How deep do you plan to dive on dive #" + diveNumber + "?");
            
            System.out.println("(in feet, up to 140 feet deep)");
            if (in.hasNextInt()){
                ...
                String bagDepthEstimate = in.nextLine();
                System.out.println();
    ...
    dimensional array
    */
    private ArrayList<Integer> getAtDepthTimes(int depthIndex){
