...
*         int random = minimum + (int) (Math.random() 
* maximum);*  7. Decision Structure
*      if(condition) {
*               your instructions ...
*      } else {
*               your instructions ...
...
/*System.out.println(userInput);*/    int intNum = Integer.parseInt(userInput);    JOptionPane.showMessageDialog(null, intNum, "Your guess", 
